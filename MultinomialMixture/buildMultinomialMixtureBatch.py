...
parser.add_option("-B", '--batchSize', action="store", dest="B", default="1000", help="size of the minibatch")
parser.add_option("-R", '--learnRate', action="store", dest="R", default="1", help="learn rate (between 0 and 1)")
