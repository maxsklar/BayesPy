...
parser.add_option('-N', '--N', dest='N', default='1000', help='Number of rows of data to sample')
parser.add_option('-M', '--M', dest='M', default='1000', help='Number of points per row to sample')
